defmodule MusicianMemory.RepoTest do
  ...
  test "search/2 returns matching memories by FTS", %{db: db} do
    Repo.insert(db, %{type: "user", scope: "private", body: "Andre is an Elixir developer", tags: "elixir"})
    Repo.insert(db, %{type: "project", scope: "team", body: "Project uses PostgreSQL", tags: "database"})
